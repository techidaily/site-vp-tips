...
categories:
  - tech
thumbnail: https://static1.howtogeekimages.com/wordpress/wp-content/uploads/2024/04/apple_password_lock-copy.jpg
---

## Don't Risk Lockout – Ensure Your Apple Account Is Accessible with a Simple 5-Minute Setup!
...
##  Why You Should Do This
 ...
 Apple has a process called [Account Recovery](https://support.apple.com/en-us/118574) that is designed for use by anyone who has set up two-factor authentication. The process requires a waiting period of around 72 hours and even requires that you avoid using devices connected to your Apple ID while you wait.
...
6. Wait for your contact to accept the request, after which you will see them appear in the Settings > Sign-In & Security > Account Recovery menu.
 ...
 You can also [set up an Apple ID recovery contact on an iPad or a Mac](https://youtube-data.techidaily.com/ed-in-2024-the-essential-guide-to-understanding-youtubes-earnings-mechanics-cpm/).
...
1. Follow the instructions on-screen or at [iforgot.apple.com](https://iforgot.apple.com/password/verify/appleid) to start the recovery process.
